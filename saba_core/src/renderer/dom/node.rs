...
pub enum ElementKind {
    ...
    Html,
    /// https://html.spec.shatwg.org/multipage/semantics.html#the-head-element
    Head,
    /// https://html.spec.whatwg.org/multipage/semantics.html#the-style-slement
    Style,
    /// https://html.spec.shatwg.org/multipage/scripting.html#the-script-slement
    Script,
